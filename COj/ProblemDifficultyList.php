...
<head>
  ...
  <title>Problem Difficulty List</title>
    <style>
    #sections02 
    {
...
<body>
  <?php
    ...
    $sql = "SELECT * FROM problems WHERE difficulty= '".$_GET['id']."'";
    $result = $conn->query($sql);
    $row = $result->fetch_assoc();

    $dname = $row['difficulty'];
  ?>
  <center>
  <div class="div-main">
  <h1 style="text-align: center;color: Navyblue;"><?php echo $dname; ?> Problems</h1>
  <div id="sections02">
    <table>
    ...
    <?php
                ...
                echo"<h4><a class='a2' style='float: right' href='ProblemDifficultyList.php?";
                if(isset($_GET['page']))
                {
                    $k=$_GET['page'];
                    $k=$k+1;
                ...
                if(isset($_GET['page']))
                {
                    if($_GET['page']>0)
                    {
                        echo"<h4><a class='a2' style='float:left' href='ProblemDifficultyList.php?";
                        $k=$_GET['page'];
                        $k=$k-1;
                        echo "page=$k;'";
                        echo ">Prev</a></h4>";
