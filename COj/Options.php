<?php
    ...
    if($curPage == 'problemset' or $curPage == 'problemcategory' or $curPage == 'practicesubmission' or $curPage == 'pendingproblems') {
        $curPage = 'practice';
    }
?>
...
<body>
    <div class="sticky-div">
        <ul class="options">
            ...
            <li class="options dropdown dropdown-left"><a class="options<?php if($curPage == 'practice') print(' active'); ?>">Practice</a>
                <div class="dropdown-content dropdown-content-left">
                    <a href="ProblemSet.php">Problem Set</a>
                    <a href="ProblemCategory.php">Problem Category</a>
                    <a href="PracticeSubmission.php">My Submission</a>
                    <?php if($_SESSION['usertype']==3){ echo '<a href="PendingProblems.php">Pending Problems</a>'; } ?>
                </div>
            </li>
            <li class="options"><a class="options<?php if($curPage == 'practiceranklist') print(' active'); ?>" href="PracticeRanklist.php">Ranklist</a></li>
            <li class="options"><a class="options<?php if($curPage == 'contest') print(' active'); ?>" href="contest.php">Contest</a></li>
